...
def main(page: ft.Page):
    ...
    page.bgcolor = ft.colors.BLUE_GREY_50  # 整体背景色设置为淡灰色，显得更高级
    page.window_width = 400
    page.window_height = 700

    current_user_code = ""
    all_salary_data = []  # 用来把后端查到的数据暂存在手机里，方便按月筛选
    ...
    def show_main_page():
        ...
        page.update()
        fetch_salary_data()  # 进主页后立刻向后端要数据
